<script context="module">
  ...
  <script>
    ...
    export let cssClassWindowWrap = "window-wrap";
    export let cssClassBg = "bg";
    export let cssClassWindow = "window";
    export let cssClassClose = "close";
    export let cssClassContent = "content";
  ...
  {#if Component}
    <div
      ...
      style={cssBg}
    >
      <div class={cssClassWindowWrap} bind:this={wrap} style={cssWindowWrap}>
        <div
          class={cssClassWindow}
          role="dialog"
          aria-modal="true"
        ...
        >
          {#if state.closeButton}
            ...
            {:else}
              <button on:click={close} class={cssClassClose} style={cssCloseButton} />
            {/if}
          {/if}
          <div class={cssClassContent} style={cssContent}>
